    ...
    public void VerificationItem(ItemResource newItem, GameObject itemScene)//atraves de um switch verifico o tipo do item e chamo a funcao de adicionar o item à determinada lista.
    {
        switch (newItem.itemType)
        {
            case ItemType.Other:
                ...
                VerificationList(newItem, slots, itemScene);
                Debug.Log("é um item");
                break;
            ...
            case ItemType.Equipment:
                VerificationList(newItem, weaponSlot, itemScene);
                Debug.Log("é um equipamento");
                break;
        }
    }
    public void VerificationList(ItemResource item, List <Slot> list, GameObject ItemScene)
    {
